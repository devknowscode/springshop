...
const Fashion = () => {
  return (
    <>
      ...
      <TopCollection noTitle="null" backImage={true} type="fashion" title="Bộ sưu tập" subtitle="" productSlider={Product4} designClass="section-b-space p-t-0 ratio_asos px-2" noSlider="false" cartClass="cart-info cart-wrap" />
      <Parallax />
